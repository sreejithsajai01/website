...
export default function AsstManagingTrustee() {
  return (
    <div>
      <h2 className="text-3xl font-sans font-bold text-primary mb-8">Secretary — MOCCB</h2>
      ...
      <p className="text-muted-foreground text-lg leading-relaxed mb-4">
        The Secretary plays a vital role in the day-to-day administration and coordination of MOCCB's educational institutions, working closely with school principals and management teams to ensure smooth operations.
      </p>
