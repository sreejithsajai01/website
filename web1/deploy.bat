@echo off
REM St. Mary's School 1 - Build, Push, and Deploy Script (Windows)
...
set SERVICE_NAME=st-marys-1
set IMAGE_NAME=gcr.io/%PROJECT_ID%/%SERVICE_NAME%
set REGION=asia-south1

echo 🏗️  Starting deployment process for St. Mary's School 1...
...
echo.
echo ✨ Your St. Mary's School 1 is now live without Replit branding!
