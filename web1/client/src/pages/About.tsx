    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-24">
        ...
        <section className="relative py-32 bg-primary text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <h1 className="text-5xl md:text-7xl font-serif mb-6">About St. Mary's</h1>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <div>
                <h2 className="text-4xl font-serif text-primary mb-6">Our Mission</h2>
              ...
              <div>
                <h2 className="text-4xl font-serif text-primary mb-6">Our Vision</h2>
                <p className="text-muted-foreground text-lg leading-relaxed">
        ...
        <section className="py-24 bg-secondary/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl md:text-5xl font-serif text-center text-primary mb-16">Our Core Values</h2>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-serif text-center text-primary mb-12">Our History</h2>
